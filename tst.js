...
var privkey = fs.readFileSync(args.privkey).toString() || assert("Cannot read private key")
var pubkey = fs.readFileSync(args.pubkey).toString() || assert("Cannot read public key")
...
if(args.encrypt === "public") enc.setPublicKey(pubkey)
if(args.encrypt === "private") enc.setPrivateKey(privkey)

if(args.decrypt === "public") dec.setPublicKey(pubkey)
if(args.decrypt === "private") dec.setPrivateKey(privkey)
